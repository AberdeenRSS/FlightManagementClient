<template>
    <v-select v-if="series" density="compact" v-model="widgetData.selectedSeriesMulti['lat']" label="Select Latitude" no-data-text="No part selected/Part has no series" :items="series"></v-select>
    <v-select v-if="series" density="compact" v-model="widgetData.selectedSeriesMulti['lon']" label="Select Longitude" no-data-text="No part selected/Part has no series" :items="series"></v-select>
